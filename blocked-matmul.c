...
//A is I by J, B is J by K, C is I by K 
int main(int argc, char* argv[]) {
    ...
    if (argc != 4){
        ...
        printf("A is I by J, B is J by K, C is I by K\n");
        printf("Where I K and J are divisible by two\n");
        return 1;
    }
    int I  = atoi(argv[1]);
    int K  = atoi(argv[2]);
    int J  = atoi(argv[3]);
    if((I % 2) != 0  || (K % 2) != 0  || (J % 2) != 0){
